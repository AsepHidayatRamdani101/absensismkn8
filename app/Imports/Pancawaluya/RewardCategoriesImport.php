...
class RewardCategoriesImport implements ToCollection, WithHeadingRow
{
    ...
    public function collection(Collection $rows): void
    {
        foreach ($rows as $index => $row) {
            ...
            $model = RewardCategory::query()->withTrashed()->firstOrNew(['code' => $data['code']]);
            $exists = $model->exists;
    ...
    {
        return "Import kategori reward selesai. Dibuat {$this->createdCount}, diperbarui {$this->updatedCount}.";
    }
