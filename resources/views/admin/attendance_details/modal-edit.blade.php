        ...
        <div class="modal-content">
            <form id="formEdit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Absensi Siswa Oleh Guru</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select id="edit_teacher_attendance_id" name="teacher_attendance_id" class="form-control"
                            required>
                    ...
                    <div class="form-row mb-0">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="time" id="edit_jam_absen" name="jam_absen" class="form-control">
                        </div>
