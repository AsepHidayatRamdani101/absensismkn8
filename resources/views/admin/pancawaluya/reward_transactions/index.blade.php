...
@section('title', 'Reward Transaction')
@section('plugins.Datatables', true)
@section('plugins.Select2', true)

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Pancawaluya - Reward Transaction</h1>
        <div>
            <a href="{{ route('pancawaluya.reward-transactions.template') }}" class="btn btn-outline-secondary mr-1"><i
                    class="fas fa-file-download"></i> Template</a>
            <a href="{{ route('pancawaluya.reward-transactions.export.excel', request()->query()) }}"
                class="btn btn-success mr-1"><i class="fas fa-file-excel"></i> Excel</a>
            <a href="{{ route('pancawaluya.reward-transactions.export.csv', request()->query()) }}"
                class="btn btn-info mr-1"><i class="fas fa-file-csv"></i> CSV</a>
            <a href="{{ route('pancawaluya.reward-transactions.export.pdf', request()->query()) }}"
                class="btn btn-danger mr-1"><i class="fas fa-file-pdf"></i> PDF</a>
            <a href="{{ route('pancawaluya.reward-transactions.print', request()->query()) }}" target="_blank"
                class="btn btn-dark mr-1"><i class="fas fa-print"></i> Print</a>
            <form action="{{ route('pancawaluya.reward-transactions.import') }}" method="POST"
            ...
            <a href="{{ route('pancawaluya.reward-transactions.create') }}" class="btn btn-primary d-none"><i
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="tableRewardTransactions" width="100%">
                    <thead>
                        <tr>
    ...
    @include('admin.pancawaluya.reward_transactions.modal-create')
    @include('admin.pancawaluya.reward_transactions.modal-edit')
@stop
