        ...
        <div class="modal-content">
            <form id="formCreate" enctype="multipart/form-data">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Tambah Reward Transaction</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="reward_category_id" id="createRewardCategory"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="reward_item_id" id="createRewardItem" class="form-control select2-modal"
                                required>
