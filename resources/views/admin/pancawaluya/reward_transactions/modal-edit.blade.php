        ...
        <div class="modal-content">
            <form id="formEdit" enctype="multipart/form-data">
                ...
                <div class="modal-header bg-warning">
                    <h5 class="modal-title">Edit Reward Transaction</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="reward_category_id" id="editRewardCategory" class="form-control select2-modal"
                                required>
                        ...
                        <div class="form-group col-md-4">
                            <label>Reward <span class="text-danger">*</span></label>
                            <select name="reward_item_id" id="editRewardItem" class="form-control select2-modal"
                                required>
                                <option value="">Pilih Reward</option>
                                @foreach ($items as $item)
                                    <option value="{{ $item->id }}"
                                        data-category-id="{{ $item->reward_category_id }}">
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
