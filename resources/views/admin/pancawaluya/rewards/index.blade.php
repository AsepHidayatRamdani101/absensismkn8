...
@section('title', 'Master Reward')
@section('plugins.Datatables', true)
@section('plugins.Select2', true)

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Pancawaluya - Master Reward</h1>
        <div>
            <a href="{{ route('pancawaluya.rewards.template') }}" class="btn btn-outline-secondary mr-1"><i
                    class="fas fa-file-download"></i> Template</a>
            <a href="{{ route('pancawaluya.rewards.export.excel', request()->query()) }}" class="btn btn-success mr-1"><i
                    class="fas fa-file-excel"></i> Excel</a>
            <a href="{{ route('pancawaluya.rewards.export.csv', request()->query()) }}" class="btn btn-info mr-1"><i
                    class="fas fa-file-csv"></i> CSV</a>
            <a href="{{ route('pancawaluya.rewards.export.pdf', request()->query()) }}" class="btn btn-danger mr-1"><i
                    class="fas fa-file-pdf"></i> PDF</a>
            <a href="{{ route('pancawaluya.rewards.print', request()->query()) }}" target="_blank"
                class="btn btn-dark mr-1"><i class="fas fa-print"></i> Print</a>
            <form action="{{ route('pancawaluya.rewards.import') }}" method="POST" enctype="multipart/form-data"
            ...
            <a href="{{ route('pancawaluya.rewards.create') }}" class="btn btn-primary d-none"><i class="fas fa-plus"></i>
                Tambah</a>
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="tableRewards" width="100%">
                    <thead>
                        <tr>
    ...
    @include('admin.pancawaluya.rewards.modal-create')
    @include('admin.pancawaluya.rewards.modal-edit')
@stop

@section('js')
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    @include('admin.pancawaluya.rewards._script')
@stop
