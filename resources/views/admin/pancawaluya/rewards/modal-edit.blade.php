        ...
        <div class="modal-content">
            <form id="formEdit">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Reward</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="reward_category_id" id="editRewardCategoryId"
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" step="0.01" min="0" name="weight" id="editWeight"
