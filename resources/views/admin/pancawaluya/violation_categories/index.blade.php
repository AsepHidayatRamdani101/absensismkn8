...
@section('title', 'Master Violation Category')
@section('plugins.Datatables', true)

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Pancawaluya - Master Violation Category</h1>
        <div>
            <a href="{{ route('pancawaluya.violation-categories.template') }}" class="btn btn-outline-secondary mr-1"><i
                    class="fas fa-file-download"></i> Template</a>
            <a href="{{ route('pancawaluya.violation-categories.export.excel', request()->query()) }}"
                class="btn btn-success mr-1"><i class="fas fa-file-excel"></i> Excel</a>
            <a href="{{ route('pancawaluya.violation-categories.export.csv', request()->query()) }}"
                class="btn btn-info mr-1"><i class="fas fa-file-csv"></i> CSV</a>
            <a href="{{ route('pancawaluya.violation-categories.export.pdf', request()->query()) }}"
                class="btn btn-danger mr-1"><i class="fas fa-file-pdf"></i> PDF</a>
            <a href="{{ route('pancawaluya.violation-categories.print', request()->query()) }}" target="_blank"
                class="btn btn-dark mr-1"><i class="fas fa-print"></i> Print</a>
            <form action="{{ route('pancawaluya.violation-categories.import') }}" method="POST"
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="tableViolationCategories" width="100%">
                    <thead>
                        <tr>
...
@section('js')
    ...
    @include('admin.pancawaluya.violation_categories._script')
@stop
