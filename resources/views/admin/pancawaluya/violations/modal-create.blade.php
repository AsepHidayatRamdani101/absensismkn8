        ...
        <div class="modal-content">
            <form id="formCreate">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Master Pelanggaran</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="violation_category_id" class="form-control select2-modal" required>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" step="0.01" name="weight" class="form-control" value="-1"
                                required>
                        </div>
                    </div>
