...
@section('title', 'Laporan Agenda Guru')

@section('plugins.Datatables', true)

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Laporan Agenda Guru</h1>
        <div class="d-flex">
            <a href="{{ route('reports.teacher-agenda.pdf', request()->query()) }}" class="btn btn-danger btn-sm mr-2">
                <i class="fas fa-file-pdf"></i> Download PDF
            </a>
            <a href="{{ route('reports.teacher-agenda.excel', request()->query()) }}" class="btn btn-success btn-sm">
...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="GET" action="{{ route('reports.teacher-agenda') }}" class="mb-3">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3 d-flex align-items-end">
                        <button type="submit" class="btn btn-primary btn-sm mr-2"><i class="fas fa-filter"></i>
                            Terapkan</button>
                        <a href="{{ route('reports.teacher-agenda') }}" class="btn btn-secondary btn-sm">Reset</a>
                    </div>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table id="tableTeacherAgendaReport" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
    ...
    <script>
        $(function() {
            ...
            function togglePeriodField() {
                ...
                $('.period-field').hide();
                if (periodType) $('.period-field[data-type="' + periodType + '"]').show();
            }
