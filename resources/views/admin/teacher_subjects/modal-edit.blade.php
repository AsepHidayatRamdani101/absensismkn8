    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formEdit">
                ...
                <input type="hidden" id="edit_classroom_id_value" name="classroom_id">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="edit_classroom_id" class="form-control" disabled style="width: 100%;">
                            <option value="">- Pilih Kelas -</option>
                            @foreach ($classrooms as $classroom)
                                <option value="{{ $classroom->id }}">{{ $classroom->nama_kelas }}</option>
                            @endforeach
                        </select>
                        <small class="form-text text-muted">Kelas tetap saat edit data.</small>
                    </div>
                </div>
