...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <span class="badge badge-light border px-3 py-2 mt-2 mt-md-0">
            Wali Kelas: {{ $teacher->nama_lengkap }}
        </span>
    </div>
@stop
...
@section('content')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('guru.wali-kelas.mid-class-permits.store') }}"
                ...
                <div class="form-row align-items-end mb-2">
                    <div class="form-group col-12 col-md-6 mb-md-0">
                        ...
                        <select name="student_id" id="wali_mid_student" class="form-control" required style="width:100%;">
                    ...
                    <div class="form-group col-12 col-md-6 mb-0">
                        ...
                        <div class="d-flex flex-wrap align-items-center" style="gap:.75rem;margin-top:.45rem;">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="wali_tipe_penuh" name="tipe_izin" value="penuh"
                                    class="custom-control-input"
                                    {{ old('tipe_izin', 'penuh') === 'penuh' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="wali_tipe_penuh">
                                    <span class="badge badge-warning">Pulang Penuh</span>
                                    <small class="text-muted ml-1">— tidak kembali</small>
                                </label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="wali_tipe_sementara" name="tipe_izin" value="sementara"
                                    class="custom-control-input" {{ old('tipe_izin') === 'sementara' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="wali_tipe_sementara">
                ...
                <div class="form-row align-items-end mb-2">
                    ...
                    <div class="form-group col-6 col-md-2 mb-md-0" id="wali_jam_kembali_wrap"
                        style="{{ old('tipe_izin', 'penuh') === 'sementara' ? '' : 'display:none;' }}">
                        <label class="mb-1 font-weight-semibold">Jam Kembali</label>
                        <input type="time" name="jam_kembali" id="wali_jam_kembali" class="form-control"
                ...
                <p class="text-muted small mb-3" id="wali_info_penuh">
                    <i class="fas fa-info-circle text-warning mr-1"></i>
                    Semua jam belajar <strong>setelah jam pulang</strong> pada hari ini akan otomatis diisi
                    <strong>Izin</strong>.
                </p>
                <p class="text-muted small mb-3" id="wali_info_sementara" style="display:none;">
                ...
                <div class="form-row align-items-start">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="file" name="foto_izin" id="wali_mid_foto" class="form-control-file"
                            accept="image/*" data-preview-wrap="#wali_mid_preview_wrap"
                            data-preview-image="#wali_mid_preview">
                        <small class="text-muted d-block mt-1">JPG / JPEG / PNG / WEBP &bull; maks 5 MB.</small>
                        <div id="wali_mid_preview_wrap" class="mt-2 d-none">
                            <img id="wali_mid_preview" src="" alt="Preview"
                ...
                <div class="border-top pt-3 mt-1">
                    ...
                    <button type="reset" class="btn btn-outline-secondary ml-2" id="btnResetWaliMid">
    ...
    <div class="card">
        <div class="card-header">
            <strong>Riwayat Izin Pulang Siswa</strong>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="tableWaliMidPermits" class="table table-bordered table-striped mb-0">
                    <thead>
                        <tr>
                            <th width="4%">No</th>
                            <th>Siswa</th>
...
@section('js')
    <script>
        $(function() {
            ...
            $('#btnResetWaliMid').on('click', function() {
                $('#wali_mid_student').val('').trigger('change');
                $('#wali_mid_preview_wrap').addClass('d-none');
                $('#wali_mid_preview').attr('src', '');
                $('#wali_tipe_penuh').prop('checked', true).trigger('change');
            });

            function toggleWaliJamKembali() {
                const isSementara = $('#wali_tipe_sementara').is(':checked');
                $('#wali_jam_kembali_wrap').toggle(isSementara);
                $('#wali_info_sementara').toggle(isSementara);
                $('#wali_info_penuh').toggle(!isSementara);
                if (!isSementara) $('#wali_jam_kembali').val('');
            }

            $('input[name="tipe_izin"]').on('change', toggleWaliJamKembali);
            toggleWaliJamKembali();
        });
    </script>
